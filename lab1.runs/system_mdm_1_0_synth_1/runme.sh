...
HD_PWD='/fs/student/ashishvyas/Vivado/lab1/lab1.runs/system_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mdm_1_0.tcl
