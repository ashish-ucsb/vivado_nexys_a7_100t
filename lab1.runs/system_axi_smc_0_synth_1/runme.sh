...
HD_PWD='/fs/student/ashishvyas/Vivado/lab1/lab1.runs/system_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_smc_0.tcl
